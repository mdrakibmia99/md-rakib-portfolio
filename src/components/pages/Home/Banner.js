    ...
    return (
        <div className="hero mb-32">
            <div className="hero-content flex-col w-full justify-around lg:flex-row-reverse">
                ...
                >
                    <img src="images/rakibahasan.png" alt='me' />
                </motion.div>
                <motion.div
                    initial={{ opacity: 0, x: -50, scale: 0.9 }}
                    animate={{ opacity: 1, x: 0, scale: 1 }}
                    ...
                    className='max-w-2xl'
                >
                    <h1 className="text-5xl font-semibold mb-5">Hi! I am Rakib!</h1>
                    ...
                    <a href="https://drive.google.com/file/d/14AwRNQ28vvH4u936eQ4DNH85PRV8nv--/view?usp=sharing" target="_blank" className="btn btn-primary">Download Resume</a>
                </motion.div>
            </div>
        </div>
    );
